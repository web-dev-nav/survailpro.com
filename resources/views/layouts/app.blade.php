        ...
        <div class="w-full px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="hidden lg:flex justify-center space-x-1">
                    ...
                    <a href="{{ route('services-new') }}" class="px-6 py-4 text-white font-semibold {{ Route::currentRouteName() == 'services-new' ? 'bg-survail-brown bg-opacity-30 border-b-3 border-yellow-400' : 'hover:bg-white hover:bg-opacity-15 hover:text-yellow-200' }} transition-all duration-300">New Services</a>
                ...
                <div id="mobile-menu" class="lg:hidden fixed top-20 left-0 right-0 bg-survail-green transform -translate-y-full transition-transform duration-300 ease-in-out z-30">
                    <div class="px-4 py-2 space-y-1">
                        ...
                        <a href="{{ route('services-new') }}" class="block px-4 py-3 text-white font-semibold {{ Route::currentRouteName() == 'services-new' ? 'bg-survail-brown bg-opacity-30' : 'hover:bg-white hover:bg-opacity-15' }} rounded-lg transition-colors">New Services</a>
